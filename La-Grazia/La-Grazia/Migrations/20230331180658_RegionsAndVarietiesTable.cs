...
{
    /// <inheritdoc />
    public partial class RegionsAndVarietiesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description2 = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Description3 = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Description4 = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    Description5 = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeaderLogo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    InstagramIcon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    InstagramURL = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FacebookIcon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    FacebookURL = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TwitterIcon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    TwitterURL = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PinterestIcon = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PinterestURL = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
